...
def preprocess_dataset(
    ...
    def construct_example(examples: Dict[str, List[Any]]) -> Generator[Any, None, None]:
        for i in range(len(examples["prompt"])):
            ...
            ##########################################################################3
            uncertainty = examples["uncertainties"][i] if "uncertainties" in examples else None
            ###########################################################################
            yield query, response, history, system, uncertainty
    ...
    def preprocess_supervised_dataset(examples: Dict[str, List[Any]]) -> Dict[str, Any]:
        ...
        for query, response, history, system, uncertainty in construct_example(examples):
            input_ids, labels = [], []
    ...
    def preprocess_pairwise_dataset(examples):
        ...
        model_inputs = {"prompt_ids": [], "chosen_ids": [], "rejected_ids": [], "uncertainties": []}
        for query, response, history, system, uncertainty in construct_example(examples):
            ...
            model_inputs["uncertainties"].append(uncertainty)
        return model_inputs
